...
//        ])
//        
//        // Load the SceneKit scene and convert it to RealityKit ModelEntity
//        let scene = SCNScene(named: "art.scnassets/NhaThaiTrang_LaiChau copy.scn")!
...
//            
//            // Add gesture recognizers to the model entity
