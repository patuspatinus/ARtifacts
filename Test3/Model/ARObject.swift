...
struct ARObject {
    ...
    static func createVNObjects() -> [ARObject] {
        return [
            ARObject(name: "Nhà Thái Trắng", description: "Truyện cổ của người Thái ở đây kể rằng: xưa kia, người Thái còn chưa biết làm nhà, một hôm có người mơ thấy có con rùa về báo mộng và bảo rằng: “nhìn vào hình dáng của tôi mà làm”. Thế là một kiểu nhà của người Thái hình thành với 4 chân là 4 cột trụ, vảy rùa là ngói lợp. Từ đó ngôi nhà sàn của người Thái có hình dáng như chiếc mai tùa.", image: "NhaThaiTrang", location: "Lai Châu", ARLink: "art.scnassets/NhaThaiTrang_LaiChau copy.scn"),
